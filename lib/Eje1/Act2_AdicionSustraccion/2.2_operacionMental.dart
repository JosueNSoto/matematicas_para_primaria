...
import '2.3_sumaRestFracciones.dart';

class operacionMental extends StatefulWidget {
  @override
  State<operacionMental> createState() => _operacionMentalState();
}

class _operacionMentalState extends State<operacionMental> {
  @override
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => sumaRestFracciones(),
                        ),
                      );
                    },
                    child: Text(
