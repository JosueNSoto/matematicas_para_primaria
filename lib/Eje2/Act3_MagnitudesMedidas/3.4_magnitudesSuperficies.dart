...
class magnitudesSuperficies extends StatefulWidget {
  @override
  State<magnitudesSuperficies> createState() => _magnitudesSuperficiesState();
}

class _magnitudesSuperficiesState extends State<magnitudesSuperficies> {
  @override
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              margenSup_Actividades(context, aAct3_E4),
              SizedBox(height: 5),
              Row(
