...
import '3.4_magnitudesSuperficies.dart';

class miligramo extends StatefulWidget {
  @override
  State<miligramo> createState() => _miligramoState();
}

class _miligramoState extends State<miligramo> {
  @override
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => magnitudesSuperficies(),
                        ),
                      );
                    },
                    child: Text(
